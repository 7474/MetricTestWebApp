...
#pragma warning disable SA1202 // Elements must be ordered by access
    public static class AppMetricsRegistry
    {
        ...
        public static class ProcessMetrics
        {
            ...
            {
                Context = Context,
                Name = "Process Peek Memory PagedSize",
                MeasurementUnit = Unit.Bytes,
                Tags = new MetricTags("reporter", "influxdb")
            };
            ...
            {
                Context = Context,
                Name = "Process Peek Memory VirtualSize",
                MeasurementUnit = Unit.Bytes,
                Tags = new MetricTags("reporter", "influxdb")
            };
            ...
            {
                Context = Context,
                Name = "Process Peek Memory WorkingSet",
                MeasurementUnit = Unit.Bytes,
                Tags = new MetricTags("reporter", "influxdb")
            };
            ...
            {
                Context = Context,
                Name = "Process Memory PrivateSize",
                MeasurementUnit = Unit.Bytes,
                Tags = new MetricTags("reporter", "influxdb")
            };
            ...
            {
                Context = Context,
                Name = "Process Memory VirtualSize",
                MeasurementUnit = Unit.Bytes,
                Tags = new MetricTags("reporter", "influxdb")
            };

            public static GaugeOptions ProcessWorkingSetSizeGauge = new GaugeOptions
            {
                Context = Context,
                Name = "Process Memory WorkingSet",
                MeasurementUnit = Unit.Bytes,
                Tags = new MetricTags("reporter", "influxdb")
            };
